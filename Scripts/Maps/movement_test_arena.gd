...
const PLATFORM_DEPTH: Vector2 = Vector2(0.0, 72.0)
const PLATFORM_SHADOW_OFFSET: Vector2 = Vector2(38.0, 94.0)
...
func _draw() -> void:
	...
	draw_line(points[0], points[1], Color("f1f2ef"), 3.0, true)
	draw_line(points[3], points[0], Color("e1e3e0"), 3.0, true)
	draw_line(points[1], points[2], Color("6b7074"), 3.0, true)
	draw_line(points[2], points[3], Color("777b7e"), 3.0, true)
...
func _draw_platform_grid() -> void:
	var grid_color: Color = Color(0.35, 0.37, 0.39, 0.055)
